...
```mermaid
flowchart TD
    A["I need to examine pairs in a sequence"] --> H{"Is it a mirror-symmetry<br/>question? palindrome"}
    H -->|"Yes"| F["CONVERGING TWO POINTERS"]
    H -->|"No"| B{"Is the data sorted,<br/>or may I sort it?"}
    ...
    E -->|"A pair, triplet, or count of pairs"| F
```
