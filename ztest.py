# Python Guide from 3-Hour Tutorial
...
our_print("hi2")  # Outputs: hi2, hi2hello

# Scope: Parameters are local
# s = "outside"  # NameError if uncommented: s is not defined outside function
# our_print("hi2")  # s inside function is separate from any external s
s = 87
our_print("hi2")  # Outputs: hi2, hi2hello; external s (87) is unchanged
print(s)  # Outputs: 87

# Accessing external variables
z = 42
def our_print_with_z(s):
    print(z)  # Accesses external z (42)
our_print_with_z("hi2")  # Outputs: 42
# def our_print_with_tree(s):
...
a = [1, 2, 3]
append_four_to_list(a)  # Appends 4
...
print(a is [1, 2, 3, 4])  # Outputs: False (different objects)
...
print(b)  # Outputs: [1, 2, 3, 4] (unchanged)
...
def add_one(x):
    print(x is a)  # Outputs: True (x refers to same list as a)
    x.append(4)    # Modifies the original list
    print(x is a)  # Outputs: True (still same list)
a = [1, 2, 3]
add_one(a)
print(a)  # Outputs: [1, 2, 3, 4] (modified due to side effect)

# Function with reassignment
def add_one_reassign(x):
    print(x is a)  # Outputs: True (x initially refers to a)
    x = [1, 2]    # Reassigns x to a new list
    print(x is a)  # Outputs: False (x now refers to a new object)
    return x
a = [1, 2, 3]
print(add_one_reassign(a))  # Outputs: [1, 2]
